/* ============================================================================
   ...
   Это ЕДИНСТВЕННАЯ новая таблица, добавляемая API. Существующие таблицы,
   хранимые процедуры и триггеры из 01_Create_Database.sql и
   02_Create_Triggers.sql не изменяются.
